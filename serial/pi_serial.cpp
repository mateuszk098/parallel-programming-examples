// This program evaluates PI with CPU using the Monte Carlo method
// g++ -pedantic -pipe -O3 -march=native pi_serial.cpp -o pi_serial
// Run: ./pi_serial.exe [1], where [1] is the special iteration number
